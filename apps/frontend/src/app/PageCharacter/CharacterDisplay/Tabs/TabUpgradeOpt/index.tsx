...
export default function TabUpopt() {
  ...
  const generateBuilds = useCallback(async () => {
    ...
    const nodes = optimize(nodesPreOpt, workerData, ({ path: [p] }) => p !== "dyn");
  ...
  }, [buildSetting, characterKey, database, gender, data, upgradeOptExpandSink, show20, useFilters, check4th])
