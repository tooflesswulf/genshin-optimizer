...
import { mergeBuilds, mergePlot } from '../../../../Solver/utils/common'
...
export default function TabBuild() {
  ...
  const generateBuilds = useCallback(async () => {
    ...
    try {
      ...
      const solver = vecSolver
        ? new BNBVecSolver(problem, status, maxWorkers)
        : new GOSolver(problem, status, maxWorkers)
            ...
            >
              ...
              <CardLight style={{ backgroundColor: 'red' }}>
                <CardContent style={{ backgroundColor: 'red' }}>
                  <Button
                    startIcon={
                      vecSolver ? <CheckBox /> : <CheckBoxOutlineBlank />
                    }
                    color={vecSolver ? 'success' : 'secondary'}
                    onClick={() => setVecSolver(!vecSolver)}
                  >
                    Use Unstable Solver (Id appreciate bug reports)
                  </Button>
                </CardContent>
              </CardLight>
            </Grid>
