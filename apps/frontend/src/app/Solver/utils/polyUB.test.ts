...
import { Linear, linearUB, _linearUB } from './linearUB'
...
describe('polyUB', () => {
  ...
  describe('composite', () => {
    ...
    test('higher powers', () => doTest(prod(dmg_, dmg_, em)))
  ...
  describe('wacky', () => {
    ...
    test('zero-crossing bounds', () => {
      const mon = [[{ $k: 4434, terms: ['0', '1'] }]]
      const minMax = {
        '0': { min: 0.99999999, max: 1 },
        '1': { min: 0.7, max: 1.2 },
      }

      const z = _linearUB(mon, minMax)
      console.log(z)
    })
  })
  describe('errors', () => {
